...
import SquareTag from '@/components/custom/SquareTag.vue'
import IconButton from '@/components/custom/button/IconButton.vue'
import IconTextButton from '@/components/custom/button/IconTextButton.vue'
import MoreButton from '@/components/custom/button/MoreButton.vue'
import CardBottom from '@/components/custom/card/CardBottom.vue'
import CardContainer from '@/components/custom/card/CardContainer.vue'
import CardTop from '@/components/custom/card/CardTop.vue'
import MultiSelect from '@/components/custom/input/MultiSelect.vue'
import SearchBox from '@/components/custom/input/SearchBox.vue'
import SingleSelect from '@/components/custom/input/SingleSelect.vue'
import type {
  NavGroupData,
  NavItemData
} from '@/types/custom_components/navTypes'
...
const meta: Meta<StoryArgs> = {
  title: 'Custom/Widget/Layout/BaseWidgetLayout',
  argTypes: {
    contentTitle: {
      control: 'text',
