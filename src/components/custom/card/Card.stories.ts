        ...
        <template #top>
          <CardTop :ratio="args.topRatio">
            ...
            <template v-if="args.showBottomRight" #bottom-right>
              <SquareTag v-if="args.showFileType" :label="args.fileType" />
              <SquareTag v-if="args.showFileSize" :label="args.fileSize" />
              <SquareTag v-for="tag in args.tags" :key="tag" :label="tag">
